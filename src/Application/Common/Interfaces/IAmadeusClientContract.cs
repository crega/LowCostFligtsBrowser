...
namespace LowCostFligtsBrowser.Application.Common.Interfaces
{
    ...
    public partial class OriginDestination 
    {
        ...
        /// <summary>Include other possible locations around the point, located less than this distance in kilometers away. Max:300
        /// 
    ...
    public partial class DateTimeRange 
    {
        ...
        /// <summary>Either 1, 2 or 3 extra days around the local date (IxD for +/- x days - Ex: I3D), Either 1 to 3 days after the local date (PxD for +x days - Ex: P3D), or 1 to 3 days before the local date (MxD for -x days - Ex: M3D)
        /// 
        ...
        /// <summary>1 to 12 hours around (both +and -) the local time. Possibly limited by the number of extra days when specified, i.e.  in some situations, it may not be used to exceed the maximum date range. [1-12]H format, e.g. 6H
        /// 
        /// Can not be combined with "originRadius" or "destinationRadius".
        /// </summary>
    ...
    public partial class FlightOffer 
    {
        ...
        /// <summary>If true, the flight offer can be combined with other oneWays flight-offers to complete the whole journey (one-Way combinable feature).</summary>
    ...
    public partial class Segment : FlightSegment
    {
        ...
        /// <summary>Number of stops planned on the segment for technical or operation purpose i.e. refueling</summary>
    ...
    public partial class GetFlightOffersQuery 
    {
        ...
        /// <summary>travelers in the trip. 
        /// 
        ///  Maximum number of passengers older than 2 yo (CHILD, ADULT, YOUGHT): 9.
        ///  Each adult can travel with one INFANT so maximum total number of passengers: 18</summary>
